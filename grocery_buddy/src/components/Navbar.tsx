...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <aside
        className="hidden md:flex fixed top-0 left-0 h-full w-56 bg-gray-800 text-gray-100 p-4 z-20"
        aria-label="Primary navigation"
      >
        <nav className="mt-12 w-full" aria-label="Main">
          ...
          <aside className="absolute left-0 top-0 h-full w-64 bg-gray-800 text-white p-4">
            ...
            <nav>
              <ul className="flex flex-col gap-3">
                <li>
                  <Link href="/" onClick={() => setOpen(false)} className="block px-3 py-2 rounded hover:bg-gray-700">Home</Link>
                </li>
                <li>
