      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Join Grocery Buddy to manage your recipes, plan meals, and organize your shopping
          </p>
        </div>
        ...
        {/* Features Preview */}
        <div className="text-center">
          <p className="text-sm text-gray-500 mb-4">What you'll get with Grocery Buddy:</p>
